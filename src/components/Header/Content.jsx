...
const Container = tw.div`w-full px-4  mt-5 sm:mt-0 h-full flex flex-col justify-between   lg:border-red-600 md:border-blue-600 xl:border-green-600 sm:border-yellow-600 sm:border-purple-600`;
const PositionText = tw.p`text-[40px] xl:text-[110px] font-extrabold uppercase leading-[38px] xl:leading-[110px] text-white`;
