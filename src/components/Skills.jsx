...
const Container = tw.div` flex flex-col mt-6 items-center bg-[#1a1a18] pb-14`;
const Label = tw.h3`text-[40px] font-extrabold uppercase leading-[60px] text-white -mt-8 `;
